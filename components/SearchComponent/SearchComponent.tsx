            ...
            <ul className='search-list'>
                <form className='simple_form search__form' id='new_search' action='/home/quick_filter' accept-charset='UTF-8' method='post'><input name='utf8' type='hidden' value='&#x2713;' /><input type='hidden' name='_method' value='put' /><input type='hidden' name='authenticity_token' value='zx3003hU3sX1Dj3dF/fsIut8HyjDFQxc6BvStWAz+24t8C3iZ/xg4IQHwOD/wpMPMhMJXwx2FmD8GgIAfZlSoA==' />
                    <li id='search-list-tab-persons'>
                        <div className='input select optional search_max_persons'><label id='search-label'>Aantal personen</label><select className='select optional select-no-search input--white' data-findex='2' data-placeholder='Selecteer' placeholder= '3 personen' name='search[max_persons]' id='search-max-persons'><option value=''></option>
                    ...
                    <li id='search-list-button'>
                        <div className='search-list-button-submit'>
                            <button name='button' type='submit' className='search-button' data-label='Vind mijn vakantiehuis'> <p id='search-list-button-text'>  Vind mijn vakantiehuis </p> </button>
                        </div>
                    </li>
                </form>
            </ul>
